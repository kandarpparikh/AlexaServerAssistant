...
# -*- coding: utf-8 -*-
#
# Start/stop Tagged Instances on AWS using Lambda / Alexa
#
# @author Kandarp Parikh / 15IT065 / CSPIT IT
#
...
def on_intent(intent_request, session):
    ...
    if intent_name == "StartTaggedInstances":
        ...
        return launch_instances(intent, session)
...
def launch_instances(intent, session):
    session_attributes = {}
    reprompt_text = None
    ...
    instance = ec2.run_instances(
        ...
        MaxCount=1,
        #TagSpecification=[{'ResourceType': 'instance','Tags':[tag_purpose_test]}]
    )
    #print "New instance created."
    instance_id = instance['Instances'][0]['InstanceId']

    speech_output="successfully created 1 instance with ID {}".format(instance_id)
    return build_response(session_attributes, build_speechlet_response(
...
def get_fun(intent, session):
    ...
    speech_output = "prarthan is useless!"
